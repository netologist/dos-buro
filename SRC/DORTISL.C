...
void sayi_esitle(char *sayi1, char *sayi2)
{
	char gecici;
	int s1, s2, elde, i;
...
void sayi_temizle(char *sonuc)
{
	...
	strcpy(sonuc, &sonuc[i]);
}

char cikarma(char *sayi1, char *sayi2, char *sonuc)
{
	char *s1, *s2;
	int elde = 0, kontrol, i, durum;
...
void bolme(char *bolunen, char *bolen, char *sonuc)
{
	...
	int dongu_tutucu = 0, bolen_uzunlugu, bolunen_uzunlugu = 0, j = 0;
